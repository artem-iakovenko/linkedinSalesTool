function parseJsonItem(moduleName, itemJson) {
    ...
    if (moduleName === "Potentials") {
        ...
        csvHeader = "Module;Potential Name;Sales Owner;Delivery Owner;LinkedIn Section;Result;Keywords/Technologies;Contact Name;Mainilg Day;\n";
    }
    if (moduleName === "Leads") {
        moduleZohoLink = "https://crm.zoho.com/crm/org55415226/tab/Accounts/";
        csvHeader = "Module;Account Name;LinkedIn Section;Result;Keywords/Technologies;Contact Name;Mailing Day;\n";
    }
    ...
    for (let key of Object.keys(itemJson)) {
        ...
        for (let contactItem of itemContacts) {
            ...
            for (let featuredItem of contactFeatured) {
                ...
                tableRow += featureCsvLink + ";" + featuredItem.keywordsFound + ";" + contactLink + "; " + contactItem.mailingDay + " \n";
                csvContent += tableRow;
            }
            ...
            for (let activityItem of contactActivities) {
                ...
                tableRow += activityCsvLink + ";" + activityItem.keywordsFound + ";" + contactLink + "; "+ contactItem.mailingDay +" \n";
